...
class CompoundDetails: UIViewController {
    ...
    let compoundsInfo = [
        ...
        28 : (title: "F-1,6-BP",
              description: "Fructose-1,6-bisphosphate is the turning point between the prep phase and the payoff phase of glycolysis. After fructose-1,6-bisphosphate is generated, the glycolysis pathway will be followed because the phosphofructokinase-1 step to generate frutocse-1,6-bisphosphate is irreverisble."),
        29 : (title: "Aldo",
        ...
        96 : (title: "a-Triglyc",
              description: "Adipose triglycerides are the main storage form of lipid energy. riglycerides contain more than twice as much energy as carbohydrates because they are more reduced and are hydrophobic so do not need to be packaged with water (decreasing their packing weight). Adipose triglycerides will not be mobilized until energetic demands signal for their release."),
        97 : (title: "HSL",
